			...
			<div class="banner" id="banner">
				<div class="banner-top">
					...
					<div class="banner-down-box">
							<a href="javascript:;" onclick="download_ios()" class="down-btn ios-btn"><img class="icon" src="<?php echo $theme_root ?>/images/IOS.png" alt="ios" />iPhone</a>
							<a href="javascript:;" onclick="download_android()" class="down-btn android-btn"><img class="icon" src="<?php echo $theme_root ?>/images/Android.png" alt="android" />Android</a>
					</div>
				</div>
				<div class="banner-bottom">
					...
					<div class="screenshot_box">
						...
						<img src="<?php echo $snapshots[3]['url'] ?>"/>
					</div>
