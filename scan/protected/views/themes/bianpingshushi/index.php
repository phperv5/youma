...
<html>
	<head>
	    ...
	    <link rel="stylesheet" type="text/css" href="/static/themes/bianpingshushi/css/css.css?v=2017051001">
	</head>
	<body>
		...
		<div id="main">
			<div class="banner" id="banner">
				<div class="banner-top">
					<div class="title"><div class="text"><?php echo $model['app_title']; ?></div></div>
					<div class="banner-img-box">
						<img src="/static/themes/bianpingshushi/images/banner.jpg"/>
					</div>
					<div class="banner-down-box">
						<a href="javascriopt:;" class="down-btn" onclick="download_ios()"><img class="icon" src="/static/themes/bianpingshushi/images/IOS.png"/>iPhone</a>
						<a href="javascriopt:;" class="down-btn android-btn" onclick="download_android()"><img class="icon" src="/static/themes/bianpingshushi/images/Android.png"/>Android</a>
					</div>
			...
			<div class="content" id="content">
				<div class="app_logo_box">
					<img class="app_logo" src="<?php echo $model['app_img'];?>"/><span class="app_name"><?php echo $model['app_title'];?></span>
				</div>
