...
<body class="ios">
	<div id="app">
	    <div class="browser_warp" onclick="browserHide()">
            ...
            <div class="open_browser_tips">
                <img src="/static/wechat/major/images/ios_browser_tips.png?v=2017052201"/>
            </div>
        </div>
			...
			<div class="main">
				<div class="logo_box">
					<?php 
						$preg = '/.*?(itunes\.apple\.com.*)/i';
	        			if (preg_match($preg, $model['ios_url'])){ ?>
						<img class="logo radius" src="<?php echo $model['app_img'];?>" />
					<?php }else{ ?>
				...
				<div class="app-info">
					<!--<div class="info-lable">应用信息</div>-->
					<div class="app_detail" id="app-detail">
						<div class="desc"><?php if(!empty($model['app_detail'])){?> <?php echo $model['app_detail'] ?> <?php }?></div>
					</div>
                ...
                <?php }else{?>
                    <a href="javascript:;" class="download" onclick="browserShow()"><img src="/static/wechat/major/images/ios_icon.png?v=2017052201" class="ios_icon" /><span class="text">立即下载</span></a>
                <?php } ?>
				<div class="func_box">
					<ul>
						<li class="zan">
	...
	<script src="/static/scan/js/scan.js?v=20170912020170915"></script>
