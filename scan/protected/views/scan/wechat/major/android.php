...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/static/wechat/major/css/css.css?v=20170915"/>
</head>
<body class="android">
    <div id="app">
        <div class="browser_warp" onclick="browserHide()">
            ...
            <div class="open_browser_tips">
                <img src="/static/wechat/major/images/android_browser_tips.png?v=2017052201"/>
            </div>
        </div>
        <div class="head android_head">
            <!--    头部背景    -->
            <?php if(isset($model['is_customize_domain']) && !empty($model['is_customize_domain'])) { ?>
                <img class="head_bg" src="/static/wechat/vip/images/domain_android_head.png?v=2"/>
            <?php } else { ?>
                <img class="head_bg" src="/static/wechat/vip/images/android_head.png?v=2"/>
            <?php } ?>
            <!--  头部logo  -->
            <?php 
        ...
        <div class="main_bg">
        	<div class="main">
    	        <div class="logo_box">
    	            <img class="logo" src="<?php echo $model['app_img']; ?>"/>
    	            <p class="app_name"><?php echo $model['app_title']; ?></p>
    	        </div>
    	        <div class="level_warp">
    	            <div class="star_warp">
    	                <span class="star"><img src="/static/wechat/major/images/star.png"/></span>
    	                <span class="star"><img src="/static/wechat/major/images/star.png"/></span>
    	                <span class="star"><img src="/static/wechat/major/images/star.png"/></span>
    	                <span class="star"><img src="/static/wechat/major/images/star.png"/></span>
    	                <?php if($model['isVip']){ ?>
    	                    <span class="hollow"><img src="/static/wechat/major/images/star.png"/></span>
    	                <?php }else{ ?>
    	                    <span class="star"><img src="/static/wechat/major/images/star_0.png"/></span>
    	                <?php } ?>
    	            </div>
    	        </div>
    	        <!--应用说明-->
    	        <div class="app-info">
    	            <div class="app_detail" id="app-detail">
    	                <div class="desc">
    	                	<?php if (!empty($model['app_detail'])){  ?><?php echo $model['app_detail'] ?><?php } ?>
    	                </div>
    	            </div>
                ...
                <?php if(isset($model['is_customize_domain']) && !empty($model['is_customize_domain'])) { ?>
                    <a href="javascript:;" class="download domain-download" onclick="browserShow()"><img  src="/static/wechat/major/images/android_icon.png" class="ios_icon"/><span class="text">立即下载</span></a>
                <?php }else{ ?>
                    <a href="javascript:;" class="download" onclick="browserShow()"><img  src="/static/wechat/major/images/android_icon.png" class="ios_icon"/><span class="text">立即下载</span></a>
                <?php } ?>
    	        <div class="func_box">
    	            <ul>
    	                <li class="zan">
    	                	<span <?php if($type!='preview'){ ?> onclick="tapLike()" <?php }?>>
    	                		<img class="icon" src="/static/wechat/major/images/zan.png?v=2017052201"/>
    	                ...
    	                <li class="comment">
    	                	<a <?php if($type!='preview'){ ?> href="<?php echo Yii::app()->request->baseUrl; ?>/msg/message/?access_key=<?php echo $model['access_key']; ?>" <?php }?>>
    	                		<img class="icon" src="/static/wechat/major/images/msg.png?v=2017052201"/> 
    ...
    <input type="hidden" name="isVip" id="isVip" value="<?php echo $model['isVip']; ?>" />
    <input type="hidden" name="create_time" id="create_time" value="<?php echo $model['create_time']; ?>" />
    ...
    <script src="/static/wechat/major/js/index.js?v=20170915" type="text/javascript" charset="utf-8"></script>
</body>
</html>
