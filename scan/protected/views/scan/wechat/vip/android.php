...
<div class="browser_warp" onclick="browserHide()">
    ...
    <div class="open_browser_tips">
        <img src="/static/wechat/vip/images/android_browser_tips.png?v=2017052203"/>
    </div>
</div>
...
<div id="app">
    <div class="main_bg">
    	<div class="main">
            ...
            <?php }else{ ?>
                <a href="javascript:;" class="download" onclick="browserShow()"><img src="/static/wechat/vip/images/android_icon.png" class="ios_icon"/><span class="text">立即下载</span></a>
            <?php } ?>
            <div class="func_box">
	            <ul>
	                <li class="zan">
